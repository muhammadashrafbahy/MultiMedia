...
abstract class HuffmanTree implements Comparable<HuffmanTree> {
	public final double frequency;//the value in the node is the freq value
...
class HuffmanLeaf extends HuffmanTree {
	public final char value;//  the leaf in the tree is about the char and its freq value
...
class HuffmanNode extends HuffmanTree {
	public final HuffmanTree left, right;//each node has left and right tree
...
public class huffman_code {
	...
	public  huffman_code(String str) {
		super();
		originalString = str;
	...
	private void buildString(HuffmanTree tree, StringBuffer prefix, HashMap<Character, String> result) {
		...
		if (tree instanceof HuffmanLeaf) {
			...
			result.put(leaf.value, prefix.toString());//لو وصلنا لليفف بحط الحرف في الناتج النهائي 
	...
	public String toString() {
        ...
        List<Character > character_list = new ArrayList<>();
            for (Character character : compressedResult.keySet()) {
                character_list.add(character);
            }
        return character_list;
        }
        public List<String> probability(){
        List<String > proba_list = new ArrayList<>();
            for (Character character : compressedResult.keySet()) {
                proba_list.add(compressedResult.get(character));
            }
        return proba_list;
        }
